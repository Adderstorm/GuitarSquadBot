...
class General(commands.Cog, name="general"):
    ...
    async def invite(self, context: Context) -> None:
        ...
        """
        embed = discord.Embed(
            description=f"Invite me by clicking [here](https://discordapp.com/oauth2/authorize?&client_id={self.bot.APP_ID}&scope=bot+applications.commands&permissions={self.bot.PREMISSIONS}).",
            color=0xD75BF4
        )
        try:
